...
// ... (Rest of the file remains identical to previous version, just updating the Card Component) ...
// Re-implementing the rest of the file content to ensure validity

const SingleChoiceCard = <T extends string>({
    value,
    currentValue,
    setValue,
    icon,
    label,
    subLabel
}: { value: T, currentValue: T, setValue: (v: T) => void, icon: React.ReactNode, label: string, subLabel?: string }) => (
    <OptionCard 
            ...
            <div className="min-h-[400px]">
                ...
                <>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-3xl mx-auto">
                        ...
                        <OptionCard selected={platforms.includes('linux')} onClick={() => handleToggle('linux', platforms, setPlatforms)} icon={<Laptop />} label="Linux / Otros" />
                    </div>
                </>
                )}
                ...
                <>
                    ...
                    <div className="grid grid-cols-1 gap-4 max-w-2xl mx-auto">
                        ...
                        <SingleChoiceCard value="manual-late" currentValue={updateHabit} setValue={setUpdateHabit} icon={<Clock />} label="Manual (Tarde)" />
                ...
                <>
                    ...
                    <div className="grid grid-cols-1 gap-4 max-w-2xl mx-auto">
                        <SingleChoiceCard value="both" currentValue={backup} setValue={setBackup} icon={<Server />} label="Nube + Físico (3-2-1)" />
                        <SingleChoiceCard value="cloud-auto" currentValue={backup} setValue={setBackup} icon={<Cloud />} label="Solo Nube" />
                        <SingleChoiceCard value="external-drive" currentValue={backup} setValue={setBackup} icon={<HardDrive />} label="Solo Disco Duro" />
                ...
                <>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 max-w-3xl mx-auto">
                        ...
                        <OptionCard selected={browsers.includes('other')} onClick={() => handleToggle('other', browsers, setBrowsers)} icon={<Globe />} label="Otro" centered />
                    </div>
                </>
                )}
                ...
                <>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-2xl mx-auto">
                        ...
                        <OptionCard selected={searchEngines.includes('bing')} onClick={() => handleToggle('bing', searchEngines, setSearchEngines)} icon={<Search />} label="Bing / Microsoft" />
                ...
                <>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-2xl mx-auto">
                        <OptionCard selected={emailProviders.includes('gmail')} onClick={() => handleToggle('gmail', emailProviders, setEmailProviders)} icon={<Mail />} label="Gmail" />
                        <OptionCard selected={emailProviders.includes('outlook')} onClick={() => handleToggle('outlook', emailProviders, setEmailProviders)} icon={<Mail />} label="Outlook / Hotmail" />
                        <OptionCard selected={emailProviders.includes('icloud')} onClick={() => handleToggle('icloud', emailProviders, setEmailProviders)} icon={<Cloud />} label="iCloud Mail" />
                        <OptionCard selected={emailProviders.includes('proton')} onClick={() => handleToggle('proton', emailProviders, setEmailProviders)} icon={<ShieldCheck />} label="Proton / Tutanota" />
                        <OptionCard selected={emailProviders.includes('yahoo')} onClick={() => handleToggle('yahoo', emailProviders, setEmailProviders)} icon={<Mail />} label="Yahoo / Otro" />
                    </div>
                </>
                )}
                ...
                <>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-3xl mx-auto">
                        ...
                        <OptionCard selected={messaging.includes('sms')} onClick={() => handleToggle('sms', messaging, setMessaging, 'none')} icon={<Smartphone />} label="SMS / Texto" />
                    </div>
                </>
                )}
                ...
                <>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-3xl mx-auto">
                        <OptionCard selected={cloud.includes('google-drive')} onClick={() => handleToggle('google-drive', cloud, setCloud, 'none')} icon={<Cloud />} label="Google Drive / Photos" />
                ...
                <>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-3xl mx-auto">
                        <OptionCard selected={iot.includes('alexa')} onClick={() => handleToggle('alexa', iot, setIot, 'none')} icon={<Mic />} label="Amazon Alexa" />
                        <OptionCard selected={iot.includes('google-home')} onClick={() => handleToggle('google-home', iot, setIot, 'none')} icon={<Mic />} label="Google Nest / Home" />
                        <OptionCard selected={iot.includes('ring')} onClick={() => handleToggle('ring', iot, setIot, 'none')} icon={<Clapperboard />} label="Cámaras IP / Ring" />
                        <OptionCard selected={iot.includes('smart-tv')} onClick={() => handleToggle('smart-tv', iot, setIot, 'none')} icon={<Monitor />} label="Smart TV" />
                ...
                <>
                    ...
                    <div className="grid grid-cols-1 gap-4 max-w-2xl mx-auto">
                        <SingleChoiceCard value="unique" currentValue={passwordHabit} setValue={setPasswordHabit} icon={<KeyRound />} label="Únicas" subLabel="Uso gestor de claves" />
                        <SingleChoiceCard value="mostly-unique" currentValue={passwordHabit} setValue={setPasswordHabit} icon={<KeyRound />} label="Variadas" subLabel="Variaciones de una misma base" />
                        <SingleChoiceCard value="reused" currentValue={passwordHabit} setValue={setPasswordHabit} icon={<AlertTriangle />} label="Reutilizadas" subLabel="La misma contraseña" />
                    </div>
                </>
                )}
                ...
                <>
                    ...
                    <div className="grid grid-cols-1 gap-4 max-w-2xl mx-auto">
                        <SingleChoiceCard value="app" currentValue={twoFactor} setValue={setTwoFactor} icon={<Hash />} label="App 2FA (Auth)" subLabel="Google Auth, Authy, Aegis" />
                        <SingleChoiceCard value="hardware-key" currentValue={twoFactor} setValue={setTwoFactor} icon={<ShieldCheck />} label="Llave Física" subLabel="YubiKey, Titan Key" />
                        <SingleChoiceCard value="sms" currentValue={twoFactor} setValue={setTwoFactor} icon={<Smartphone />} label="SMS" subLabel="Mejor que nada" />
                        <SingleChoiceCard value="none" currentValue={twoFactor} setValue={setTwoFactor} icon={<AlertTriangle />} label={t.assessment.options.none} subLabel="Solo contraseña" />
                    </div>
                </>
                )}
                ...
                <>
                    ...
                    <div className="grid grid-cols-1 gap-4 max-w-2xl mx-auto">
                        <SingleChoiceCard value="check-sender" currentValue={phishing} setValue={setPhishing} icon={<Search />} label={t.phishing.ui.viewDetails} subLabel="Verifico remitente y URL" />
                        <SingleChoiceCard value="check-url" currentValue={phishing} setValue={setPhishing} icon={<EyeOff />} label="Miro el enlace" subLabel="Si parece raro, no entro" />
                        <SingleChoiceCard value="open-everything" currentValue={phishing} setValue={setPhishing} icon={<AlertTriangle />} label="Abro todo" subLabel="Hago clic sin pensar" />
                    </div>
                </>
                )}
                ...
                <>
                    ...
                    <div className="grid grid-cols-1 gap-4 max-w-2xl mx-auto">
                         <OptionCard selected={risks.includes('wifi')} onClick={() => handleToggle('wifi', risks, setRisks, 'none')} icon={<Wifi />} label="Wi-Fi Público" subLabel="Sin VPN" />
                         <OptionCard selected={risks.includes('bluetooth')} onClick={() => handleToggle('bluetooth', risks, setRisks, 'none')} icon={<Bluetooth />} label="Bluetooth ON" subLabel="Siempre encendido" />
                         <OptionCard selected={risks.includes('location')} onClick={() => handleToggle('location', risks, setRisks, 'none')} icon={<MapPin />} label="Ubicación real" subLabel="Comparto en tiempo real" />
                         <OptionCard selected={risks.includes('public-charging')} onClick={() => handleToggle('public-charging', risks, setRisks, 'none')} icon={<Zap />} label="Carga USB Pública" subLabel="Aeropuertos, buses" />
                ...
                <>
                    ...
                    <div className="grid grid-cols-1 gap-4 max-w-2xl mx-auto">
                         <OptionCard selected={defense.includes('password-manager')} onClick={() => handleToggle('password-manager', defense, setDefense, 'none')} icon={<KeyRound />} label="Gestor de Contraseñas" />
                         <OptionCard selected={defense.includes('2fa-app')} onClick={() => handleToggle('2fa-app', defense, setDefense, 'none')} icon={<Hash />} label="App 2FA" />
                         <OptionCard selected={defense.includes('vpn')} onClick={() => handleToggle('vpn', defense, setDefense, 'none')} icon={<Shield />} label="VPN" />
                         <OptionCard selected={defense.includes('adblocker')} onClick={() => handleToggle('adblocker', defense, setDefense, 'none')} icon={<EyeOff />} label="AdBlocker" />
                         <OptionCard selected={defense.includes('privacy-screen')} onClick={() => handleToggle('privacy-screen', defense, setDefense, 'none')} icon={<Smartphone />} label="Filtro de Pantalla" />
